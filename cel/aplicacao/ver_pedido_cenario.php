...
/*
  This script displays the various applications for the scenario.
...
if (isset($submit)) {
    ...
    <html>
        <head>
            <title>Pedidos de altera&ccedil;&atilde;o dos Cen&agrave;rios</title>
        </head>
        <body>
...
/*
  ...
  Objective: Allow the administrator to manage requests for change scenarios.
    ...
    if ($select->getntuples() == 0) {
        ...
        while ($record != 'LAST_RECORD_REACHED') {
            ...
            if (strcasecmp($tipo_pedido, 'remover')) {
                ...
                <h3>O usu&agrave;rio <a  href="mailto:<?= $usuario['email'] ?>" >
                        <?= $usuario['nome'] ?></a> pede para <?= $tipo_pedido ?> o cen&aacute;rio <font color="#ff0000">
                        <?= $record['titulo'] ?></font> <? 
                ...
                ?>
                 ...
                 ?>
                        ...
                        <h3>O usu&agrave;rio <a  href="mailto:<?= $usuario['email'] ?>" >
                         <?= $usuario['nome'] ?></a> pede para <?= $tipo_pedido ?> o cen&agrave;rio <font color="#ff0000">
                         <?= $record['titulo'] ?></font></h3>
